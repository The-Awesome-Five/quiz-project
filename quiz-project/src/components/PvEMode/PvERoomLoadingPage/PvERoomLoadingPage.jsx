...
import { getUser, updatePlayer } from "../../../services/room.service";


export const PvERoomLoadingPage = ({
                                    players,
                                    setPlayers,
                                    roomId,
                                    user,
    ...
    return (
        <Card className="d-flex flex-column text-center align-items-center bg-light-subtle ">
            ...
            {players.length === 1 && <Card className="bg-danger-subtle">
                <h3>Waiting for another player to join. To begin a group Adventure!</h3>
            </Card>}
